...
public class CardDetailViewModel extends ViewModel {
    ...
    public CardDetailViewModel (CardDataSource cardDataSource) {
    ...
    public MutableLiveData<Card> getCardMutableLiveData () {
        if(cardMutableLiveData == null) {
            ...
            //cardMutableLiveData.setValue(new Card());
        }
    ...
    public Disposable delCard (Card card) {
        loadingState.setValue(true);
        return cardDataSource.delete(card)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(() -> {
                    loadingState.setValue(false);
